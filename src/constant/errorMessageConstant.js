...
export const MENU_ADD_TITLE_EMPTY_ERROR_MESSAGE = "菜单标题不能为空";
export const MENU_ADD_TITLE_FORMAT_ERROR_MESSAGE = "菜单标题为2-20个字符，可以是字母、数字和中文字符";
export const MENU_ADD_ROUTE_PATH_EMPTY_ERROR_MESSAGE = "菜单路由路径不能为空";
export const MENU_ADD_ROUTE_PATH_FORMAT_ERROR_MESSAGE = "菜单路由路径格式异常";
export const MENU_ADD_ROUTE_PATH_DUPLICATE_ERROR_MESSAGE = "菜单路由路径已经存在";
export const MENU_ADD_ROUTE_NAME_EMPTY_ERROR_MESSAGE = "菜单路由名称不能为空";
export const MENU_ADD_ROUTE_NAME_FORMAT_ERROR_MESSAGE = "菜单路由名称为2-20个字符，只能包含字母";
export const MENU_ADD_ROUTE_NAME_DUPLICATE_ERROR_MESSAGE = "菜单路由名称已经存在";
export const MENU_ADD_COMPONENT_PATH_EMPTY_ERROR_MESSAGE = "菜单组件路径不能为空";
export const MENU_ADD_COMPONENT_PATH_FORMAT_ERROR_MESSAGE = "菜单组件路径格式异常";
export const MENU_ADD_PERMISSION_NAME_EMPTY_ERROR_MESSAGE = "菜单权限名称不能为空";
export const MENU_ADD_PERMISSION_NAME_FORMAT_ERROR_MESSAGE = "菜单权限名称为2-50个字符，包含字母、数字、中文，不能包含特殊字符";
export const MENU_ADD_PERMISSION_EXPRESSION_EMPTY_ERROR_MESSAGE = "菜单权限表达式不能为空";
export const MENU_ADD_PERMISSION_EXPRESSION_FORMAT_ERROR_MESSAGE = "菜单权限表达式为2-100个字符，包含字母和分号";
export const MENU_ADD_PARENT_ID_EMPTY_ERROR_MESSAGE = "请选择父级菜单或者作为顶层菜单";