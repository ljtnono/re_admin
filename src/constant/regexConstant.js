...
// #################### 编辑菜单表单相关正则表达式 #################### //
export const MENU_EDIT_TITLE_REGEX = MENU_ADD_TITLE_REGEX;
export const MENU_EDIT_ROUTE_PATH_REGEX = MENU_ADD_ROUTE_PATH_REGEX;
export const MENU_EDIT_ROUTE_NAME_REGEX = MENU_ADD_ROUTE_NAME_REGEX;
export const MENU_EDIT_COMPONENT_PATH_REGEX = MENU_ADD_COMPONENT_PATH_REGEX; 
export const MENU_EDIT_PERMISSION_NAME_REGEX = MENU_ADD_PERMISSION_NAME_REGEX;
export const MENU_EDIT_PERMISSION_EXPRESSION_REGEX = MENU_ADD_PERMISSION_EXPRESSION_REGEX;
